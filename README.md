...
Features:
  ...
  5. Pushing notifications to the user with the FCM library. 
  6. Using ViewModel, Stateflow and NavHost to make allow for a smooth experience while maintaining the readability and a clean connection between the UI and View layers of the codebase.  
